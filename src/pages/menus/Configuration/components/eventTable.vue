<template>
  <el-table :data="eventList" @selection-change="handleSelectionChange" style="width: 100%;">
    ...
    <el-table-column prop="msgt" :min-width="minWidth" label="Type" />
    <el-table-column prop="cobj" :min-width="minWidth" label="Object2" />
    <el-table-column prop="catt" :min-width="minWidth" label="Attribute2" />
    <el-table-column prop="acat" :min-width="minWidth" label="Category" />
    <el-table-column prop="subr" :min-width="minWidth" label="Subroutine" />
    <el-table-column :width="160" v-if="showBtn">
      <template slot-scope="scope">
        <el-button type="text" @click="handleEdit(scope.row, scope.$index)">Edit</el-button>
