...
export const handleExcelFile = (file: { raw: Blob }): Promise<ParsedTableData> => {
...
export const createExcelFileFromTableData = (content: Array<Array<unknown>>): Promise<boolean | Error> => {
  return new Promise((resolve, reject) => {
    try {
