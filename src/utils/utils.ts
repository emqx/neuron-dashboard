 ...
 */
export const createOptionListFromEnum = (e: Record<string, any>) => Object.keys(e)
...
export const paginate = (data: Array<any>, pageSize: number, pageNumber: number) => data.slice((pageNumber - 1) * pageSize, pageNumber * pageSize)
...
export const createMapFromArray = (array: Array<Record<any, any>>, mapKey = 'id') => array.reduce((obj, curr) => {
...
export const exportExcelData = (content: Array<any>, fileName: string) => new Promise((resolve, reject) => {
  try {
